...
// test variables
let num1 = new bI.BigInt('26325');
let num2 = new bI.BigInt('-44125253');


// Test #1
test('Adding num1 + num2', () => {
    expect(num1.add(num2).toString()).toBe('-44098928');
});

// Test #2
test('Subtracting num1 - num2', () => {
    expect(num1.subtract(num2).toString()).toBe('44151578');
});

// Test #3
test('Reverse Subtracting num2 - num1', () => {
    expect(num2.subtract(num1).toString()).toBe('-44151578');
});

// // Test #4
// test('Multiplying num1 * num2', () => {
//     expect(num1.multiply(num2).toString()).toBe('-1000000000000');
// });
